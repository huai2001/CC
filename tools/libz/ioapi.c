...
#if defined(__APPLE__) || defined(IOAPI_NO_64) || defined(ANDROID) || defined(__ANDROID__)
...
static uLong ZCALLBACK fread_file_func (voidpf opaque, voidpf stream, void* buf, uLong size) {
    uLong res;
    res = (uLong)fread(buf, 1, (size_t)size, (FILE *)stream);
    return res;
}

static uLong ZCALLBACK fwrite_file_func (voidpf opaque, voidpf stream, const void* buf, uLong size) {
    uLong res;
    res = (uLong)fwrite(buf, 1, (size_t)size, (FILE *)stream);
    return res;
}
