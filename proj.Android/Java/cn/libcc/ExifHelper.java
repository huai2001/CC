...
public class ExifHelper {
    ...
    public StringBuffer getString() {
        ...
        str.append("aperture:"+this.aperture+"\n");
        str.append("datetime:"+this.datetime+"\n");
        str.append("exposureTime:"+this.exposureTime+"\n");
        str.append("flash:"+this.flash+"\n");
        str.append("focalLength:"+this.focalLength+"\n");
        str.append("gpsAltitude:"+this.gpsAltitude+"\n");
        str.append("gpsAltitudeRef:"+this.gpsAltitudeRef+"\n");
        str.append("gpsDateStamp:"+this.gpsDateStamp+"\n");
        str.append("gpsLatitude:"+this.gpsLatitude+"\n");
        str.append("gpsLatitudeRef:"+this.gpsLatitudeRef+"\n");
        str.append("gpsLongitude:"+this.gpsLongitude+"\n");
        str.append("gpsLongitudeRef:"+this.gpsLongitudeRef+"\n");
        str.append("gpsProcessingMethod:"+this.gpsProcessingMethod+"\n");
        str.append("gpsTimestamp:"+this.gpsTimestamp+"\n");
        str.append("iso:"+this.iso+"\n");
        str.append("make:"+this.make+"\n");
        str.append("model:"+this.model+"\n");
        str.append("orientation:"+this.orientation+"\n");
        str.append("whiteBalance:"+this.whiteBalance+"\n");
        return str;
    }
    /**
