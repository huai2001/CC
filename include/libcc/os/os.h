#ifndef _C_CC_CONFIG_OS_H_INCLUDED_
#define _C_CC_CONFIG_OS_H_INCLUDED_

/**/
#if defined(_AIX) || defined(__AIX) || defined(__AIX__) || defined(__aix) || defined(__aix__)
#define __CC_AIX__     1
#define __CC_OS_NAME__ "AIX"
#endif

#if defined(__HAIKU__)
#define __CC_HAIKU__   1
#define __CC_OS_NAME__ "Haiku"
#endif

#if defined(bsdi) || defined(__bsdi) || defined(__bsdi__)
#define __CC_BSDI__    1
#define __CC_OS_NAME__ "BSDI"
#endif
...
#define __CC_OS_NAME__ "HP-UX"
#endif

#if defined(sgi) || defined(__sgi) || defined(__sgi__) || defined(_SGI_SOURCE)
#define __CC_IRIX__    1
#define __CC_OS_NAME__ "SGI"
#endif

#if defined(osf) || defined(__osf) || defined(__osf__) || defined(_OSF_SOURCE)
#define __CC_OSF__     1
#define __CC_OS_NAME__ "OSF1"
#endif

#if defined(__QNX__) || defined(__QNXNTO__)
#define __CC_QNX__  1
#define __CC_OS_NAME__ "QNX"
#endif

#if defined(__sun) && defined(__SVR4)
    #define __CC_SOLARIS__ 1
    #define __CC_OS_NAME__ "SunOS"
#endif
...
#if defined(__CC_MSVC__) && defined(__has_include)
...
#elif defined(__CC_MSVC__) && (__CC_MSVC__ >= 1700 && !_USING_V110_SDK71_)    /* __CC_MSVC__ == 1700 for Visual Studio 2012 */
    #define WINAPI_FAMILY_H 1
#else
    #define WINAPI_FAMILY_H 0
#endif
 ...
 */
    ...
    #define __CC_OS_NAME__ "__native_client__"
#endif

#if defined(__pnacl__)
    #undef __LINUX__
    #define __CC_PNACL__ 1
    #define __CC_OS_NAME__ "__pnacl__"
#endif

#if defined(__OS2__)
    #define __CC_OS2__    1
    #define __CC_OS_NAME__ "OS2"
#endif

#if defined(__CYGWIN__)
    #define __CC_CYGWIN__ 1
    #define __CC_OS_NAME__ "Cygwin"
#endif
    ...
    #define __CC_OS_NAME__ "RISCos"
#endif

#if defined(ANDROID) || defined(__ANDROID__)
    #undef __CC_OS_NAME__
    
    #define __CC_ANDROID__ 1
    #define __CC_OS_NAME__ "Google Android"
    ...
    /* if compiling for iPhone */
        ...
        #define __CC_OS_NAME__ "iOS"
    #elif TARGET_IPHONE_SIMULATOR
        /* iOS, tvOS, or watchOS Simulator */
        #define __CC_IPHONEOS__ 1
        #define __CC_IPHONEOS_SIMULATOR__ 1
        #define __CC_OS_NAME__ "iOS Simulator"
    #elif TARGET_OS_TV
        /* tvOS device */
        #define __CC_APPLE_TVOS__ 1
        #define __CC_OS_NAME__ "TV OS"
    #elif TARGET_OS_MAC
        /* Other kinds of Apple platforms */
        #define __CC_MACOSX__ 1
        #define __CC_OS_NAME__ "OSX"
...
#endif /* _C_CC_CONFIG_OS_H_INCLUDED_*/
