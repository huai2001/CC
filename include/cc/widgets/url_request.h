...
/**/
_CC_WIDGETS_API(bool_t) _cc_free_url_request(_cc_url_request_t *request);
/**/
...
/**
 * @brief Find URL response header
 *
 * @param headers _cc_url_request_t
 * @param key HTTP header key
 *
 */
_CC_WIDGETS_API(const tchar_t *) _cc_url_find_header(_cc_rbtree_t *headers, const tchar_t *key);
