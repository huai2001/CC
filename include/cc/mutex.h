 ...
 */
_CC_API(_cc_mutex_t*) _cc_create_mutex(void);
/** Lock the mutex
 *  @return true, or false on error
 */
_CC_API(bool_t) _cc_mutex_lock(_cc_mutex_t*);

/** Try Lock the mutex
 *  @return 0, _CC_MUTEX_TIMEDOUT_, or -1 on error
 */
_CC_API(int) _cc_mutex_try_lock(_cc_mutex_t*);
/** Unlock the mutex
 *  @return true, or false on error
 *
 ...
 */
_CC_API(bool_t) _cc_mutex_unlock(_cc_mutex_t*);
/**
 * Destroy a mutex
 */
_CC_API(void) _cc_destroy_mutex(_cc_mutex_t**);
 ...
 */
_CC_API(_cc_semaphore_t*) _cc_create_semaphore(int32_t);

/**
 * Destroy a semaphore
 */
_CC_API(void) _cc_destroy_semaphore(_cc_semaphore_t**);
 ...
 * count.
 */
_CC_API(int) _cc_semaphore_wait(_cc_semaphore_t*);
 ...
 */
_CC_API(int) _cc_semaphore_try_wait(_cc_semaphore_t*);
 ...
 */
_CC_API(int) _cc_semaphore_wait_timeout(_cc_semaphore_t*, uint32_t);

/** Atomically increases the semaphore's count (not blocking).
 *  @return true or false on error.
 */
_CC_API(bool_t) _cc_semaphore_post(_cc_semaphore_t*);

/**
 * Returns the current count of the semaphore
 */
_CC_API(uint32_t) _cc_semaphore_value(_cc_semaphore_t*);
 ...
 */
_CC_API(_cc_condition_t*) _cc_create_condition(void);

/**
 * Destroy a condition variable
 */
_CC_API(void) _cc_destroy_condition(_cc_condition_t**);

/** Restart one of the threads that are waiting on the condition variable,
 *  @return true or false on error.
 */
_CC_API(bool_t) _cc_condition_signal(_cc_condition_t*);

/** Restart all threads that are waiting on the condition variable,
 *  @return true or false on error.
 */
_CC_API(bool_t) _cc_condition_broadcast(_cc_condition_t*);
 ...
 */
_CC_API(bool_t) _cc_condition_wait(_cc_condition_t*, _cc_mutex_t*);
