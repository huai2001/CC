...
_cc_base58_encode(const byte_t *input, int32_t length, tchar_t *output, int32_t output_length);
/**
 ...
 */
_CC_API_PUBLIC(int32_t)
_cc_base58_decode(const tchar_t *input, int32_t length, byte_t *output, int32_t output_length);
