...
#if defined(_CC_JSON_EXPORT_SHARED_LIBRARY_)
#define _CC_JSON_API(t) _CC_API_EXPORT_ t
#elif defined(_CC_JSON_IMPORT_SHARED_LIBRARY_)
#define _CC_JSON_API(t) _CC_API_IMPORT_ t
#else
#define _CC_JSON_API(t) t
#endif
 ...
 * @return Buf context
 */
_CC_JSON_API(_cc_buf_t *) _cc_print_json(_cc_json_t *jctx);
 ...
 * @return JSON object
 */
_CC_JSON_API(_cc_json_t *) _cc_open_json_file(const tchar_t *file_name);
 ...
 * @return JSON object
 */
_CC_JSON_API(_cc_json_t *) _cc_parse_json(const tchar_t *src);
/**
 * @brief Parse JSON
 *
 * @return JSON object
 */
_CC_JSON_API(_cc_json_t *) _cc_josn_parser(_cc_sbuf_tchar_t *const buffer);
/**
 ...
 * @return true if successful or false on error.
 */
_CC_JSON_API(bool_t) _cc_destroy_json(_cc_json_t **ctx);
/**
 * @brief Get JSON Parse error message
 *
 * @return JSON error message string
 */
_CC_JSON_API(const tchar_t *) _cc_json_error(void);
/**
...
_CC_FORCE_INLINE_ int64_t _cc_json_number(const _cc_json_t *ctx) {
    ...
    case _CC_JSON_BOOLEAN_:
        return ctx->object.uni_boolean ? 1 : 0;
    case _CC_JSON_INT_:
        return (int64_t)ctx->object.uni_int;
    case _CC_JSON_FLOAT_:
        return (int64_t)ctx->object.uni_float;
    case _CC_JSON_STRING_:
        return (int64_t)_ttoi64(ctx->object.uni_string);
    }
    return 0;
}
...
_CC_FORCE_INLINE_ float64_t _cc_json_float(const _cc_json_t *ctx) {
    ...
    switch (ctx->type) {
    case _CC_JSON_BOOLEAN_:
        return ctx->object.uni_boolean ? 1.0f : 0.0f;
    case _CC_JSON_INT_:
        return (float64_t)ctx->object.uni_int;
    case _CC_JSON_FLOAT_:
        return ctx->object.uni_float;
    case _CC_JSON_STRING_:
        return _ttof(ctx->object.uni_string);
    }
    return 0;
}
