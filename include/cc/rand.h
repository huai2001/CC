...
/**/
_CC_FORCE_INLINE_ float32_t _cc_randf(void) {
    return (float32_t)(_cc_rand() / (float32_t)_CC_RANDOM_MAX_);
}

/**/
_CC_FORCE_INLINE_ float64_t _cc_randd(void) {
    return (float64_t)(_cc_rand() / (float64_t)_CC_RANDOM_MAX_);
}
