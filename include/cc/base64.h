 ...
 */
_CC_API(int32_t)
_cc_base64_encode(const byte_t *input, int32_t length, tchar_t *output, int32_t output_length);
/**
 ...
 */
_CC_API(int32_t)
_cc_base64_decode(const tchar_t *input, int32_t length, byte_t *output, int32_t output_length);
