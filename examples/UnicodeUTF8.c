...
int main (int argc, char * const argv[]) {
    ...
    _cc_utf8_to_utf32((uint8_t*)testes, (uint8_t*)(testes+strlen(testes)), (uint32_t*)utf32, (uint32_t*)(utf32+1024));
    //testes_print((wchar_t*)utf32,NSUTF32LittleEndianStringEncoding);
    _cc_utf8_to_utf16((uint8_t*)testes, (uint8_t*)(testes+strlen(testes)), (uint16_t*)utf16, (uint16_t*)(utf16+1024));
    //testes_print((int32_t*)utf61,NSUTF16LittleEndianStringEncoding);
    
    
    _cc_utf16_to_utf8((uint16_t*)utf16, (uint16_t*)(utf16+_cc_countof(utf16)), (uint8_t*)utf8, (uint8_t*)(utf8+1024));
