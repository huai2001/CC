...
#define _CC_IOCP_FILE_                    0xFFFFFFF1
#define _CC_IOCP_TIMEOUT_                 0xFFFFFFF2
 ...
 */
bool_t _cc_iocp_overlapped_alloc(_cc_event_cycle_priv_t *priv,_iocp_overlapped_t **iocp_overlapped);
/**
 ...
 * @return true if successful or false on error.
 */
bool_t _cc_iocp_overlapped_free(_cc_event_cycle_priv_t *priv,_iocp_overlapped_t *iocp_overlapped);
